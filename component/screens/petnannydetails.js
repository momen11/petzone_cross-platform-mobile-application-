...
export const Petnannydetails = ({route}) => {
 // const {userid} = route.params
  ...
  useEffect(() => {
    ...
    axios
      .get("https://petzone99.herokuapp.com/api/v1/users/loadServiceProvider/" + petnannyid)
      .then((res) => {
        //console.log("all",res.data);
        setserviceprovider(res.data.user);
...
function book (){
  let item ={
    ...
    serviceProvider: serviceproviderdetails._id,
    user: userid,
  }; 
{
  checkbook==true?
    axios.post("https://petzone99.herokuapp.com/api/v1/booking/bookServiceProvider",item)
  ...
  .catch(function (error) {
    ...
    :
    axios.post("https://petzone99.herokuapp.com/api/v1/booking/cancelBooking",item)
    .then(function (response) {
      setcheckbook(true)
      console.log(response);
    })
...
<View style={styles.veiwcard5}>
<Card  style={styles.card32} onPress={()=>{}}>
<Text style = {styles.title4}> {threeday}</Text>
</Card>
<Image style={styles.imagestyle2} source={require("../../assets/down-arrow.png")}/>
<Card  style={styles.card6} onPress={book2} >
{
...
title1:{paddingBottom:0, left:18,top:250, fontWeight:"bold", fontSize:16,color:"#5C7A95"},

title2:{paddingBottom:25, left:219,top:225, fontWeight:"bold",marginBottom:15, fontSize:16,color:"#5C7A95"},
title3:{paddingBottom:25, left:140,top:200, fontWeight:"bold",marginBottom:15, fontSize:16,color:"#5C7A95"},
